...
- **Recovery-Mode Coverage**: The fixture corpus now includes broken TypeScript, Python, and Java cases that assert the `recovered` analysis contract instead of silently accepting file-wide fallback behavior.
